                    ...
                    <div className="Instructions-container">
                        ...
                        <div>
                            ...
                            <ul className= 'list-style'>
                                <li className='list-space'>Use the <b>sample_airbnb database</b> to query for documents that answer the questions for this round. Note that you only need to use the <b>listingsAndReviews Collection</b> for this round.</li>
